...
class NewRc(models.Model):
    ...
    front_image = models.ImageField(
        upload_to="front_rc_legacy_new_images/", null=True, blank=True
    )
    back_image = models.ImageField(
        upload_to="back_rc_legacy_new_images/", blank=True, null=True
    )
    ...
    def save(self, *args, **kwargs):
        ...
        img_back = Image.open(media_path_back, mode="r").copy()
        ...
        if self.rto_name:
            d.text(
                (503, 399), self.rto_name, fill=(14, 15, 15), font=font, stroke_fill="black"
            )
...
class OldRc(models.Model):
    ...
    now = models.DateField(auto_now_add=True, auto_created=True)
    front_image = models.ImageField(
        upload_to="front_rc_legacy_old_images/", blank=True, null=True
    )
    back_image = models.ImageField(
        upload_to="back_rc_legacy_old_images/", blank=True, null=True
    )
