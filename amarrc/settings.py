"""
Django settings for amarrc project.
...
SECRET_KEY = "django-insecure-cvu%4=fue!h1vvc$zg(jb&e-n!i8b=nzj6b$@!mv#v-g(1i$%a"
...
WSGI_APPLICATION = "amarrc.wsgi.application"
